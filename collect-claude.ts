#!/usr/bin/env bun
// Claude Code stores transcripts under <root>/projects/<encoded-cwd>/<session-id>.jsonl; roots: CLAUDE_CONFIG_DIR (comma-separated, each <root>/projects), else ~/.claude/projects and ~/.config/claude/projects.
